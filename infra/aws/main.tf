...
resource "aws_security_group" "alb" {
  ...
  description = "NEXUSMIND public ALB traffic"
  vpc_id      = var.vpc_id
...
resource "aws_security_group" "service" {
  ...
  description = "NEXUSMIND ECS service traffic from ALB"
  vpc_id      = var.vpc_id
  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [
        ...
        { name = "SPARK_MASTER_URL", value = var.spark_master_url }
      ]
      logConfiguration = {
        logDriver = "awslogs"
        options = {
  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [
        { name = "NEXT_PUBLIC_API_BASE_URL", value = "https://api.example.com/api/v1" }
      ]
      logConfiguration = {
        logDriver = "awslogs"
        options = {
